...
import { X, Calendar, Flag, AlignLeft, Trash2, Clock, Timer } from "lucide-react";
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <div className="space-y-1">
                                    <label className="text-[10px] text-white/30 uppercase">Estimated</label>
                                    <div className="relative">
                                        ...
                                        />
                                        <Timer size={14} className="absolute right-2 top-2 text-white/20" />
                                    </div>
                                </div>
                                <div className="space-y-1">
                                    <label className="text-[10px] text-white/30 uppercase">Spent</label>
                                    <div className="relative">
                                        <input
                                            type="number"
                                            value={timeSpent}
                                            ...
                                            className="w-full bg-white/5 border border-white/5 rounded-lg pl-3 pr-2 py-1.5 text-sm text-white/80 focus:outline-none focus:border-white/20"
                                        />
                                        <Clock size={14} className="absolute right-2 top-2 text-white/20" />
                                    </div>
                                </div>
                            </div>
                        </div>
