...
const PRESETS = [
    ...
    "linear-gradient(109.6deg, rgb(36, 45, 57) 11.2%, rgb(16, 37, 60) 51.2%, rgb(0, 0, 0) 98.6%)", // Deep Space
    "#000000", // Pure Black
];
...
export default function GradientPicker({
    ...
    // Parse initial background to state or default
    const [gradientType, setGradientType] = useState<"linear" | "solid">("linear");
    ...
    // Effect to construct CSS string on change
    useEffect(() => {
        ...
        >
            ...
            <div className="flex bg-white/5 rounded-full p-1 mb-4 border border-white/5">
                <button
                    ...
                    className={`flex-1 text-xs py-1.5 rounded-full transition-all ${mode === "custom"
                ...
                <button
                    ...
                    className={`flex-1 text-xs py-1.5 rounded-full transition-all ${mode === "presets"
                            ? "bg-white/10 text-white shadow-sm"
                            : "text-white/50 hover:text-white"
                        }`}
                >
                        ...
                        <button
                            ...
                            onClick={() => {
                                if (preset.startsWith("#") || preset.startsWith("rgb")) {
                                    ...
                                    // Very basic parsing for demo purposes to restore state if needed
                                    // In a real app we'd parse the string back to state
                                    onChange(preset);
                                }
                            }}
                                        ...
                                        {colors.map((color, idx) => (
                                            <div key={idx} className="relative group">
                                                <button
                                                    ...
                                                    className={`w-8 h-8 rounded-full border-2 transition-all ${activeColorIndex === idx
