...
import { sendMessage, subscribeToMessages, ChatMessage } from '@/utils/chat-service';
        ...
        return (
            <div className="h-full flex flex-col items-center justify-center p-6">
                ...
                >
                    ...
                    <p className="text-white/50 text-center mb-8">Enter your name to start messaging.</p>
                ...
                <div className="space-y-6 pt-4">
                    ...
                    {messages.map((msg, index) => {
                        ...
                        return (
                            ...
                            >
                                {/* Avatar */}
                                <div className={`flex-none w-8 h-8 rounded-full flex items-center justify-center text-[10px] font-bold ring-1 ring-white/10 ${isMe ? 'bg-blue-500 text-white' : 'bg-white/10 text-white/70'} ${!showAvatar && 'opacity-0'}`}>
                                    {msg.sender[0].toUpperCase()}
                                </div>

                                <div className={`flex flex-col max-w-[70%] ${isMe ? 'items-end' : 'items-start'}`}>
                                    {showAvatar && !isMe && (
                                        <span className="text-[10px] text-white/40 ml-1 mb-1">{msg.sender}</span>
                                    )}
                                    <div
